...
function radialProgress($obj, options) {
  ...
  this.$radialBackground = $("<div class='first'>").appendTo($obj).css({
  ...
  this.$radialFirstHalfMask = $("<div class='second'>").appendTo($obj).css({
    "position": "absolute",
    "top": this.options['margin'],
  ...
  this.$radialSecondHalfMask = $("<div class='third'>").appendTo($obj).css({
    "position": "absolute",
    "top": this.options['margin'],
    "left": this.options['margin'],
    "width": Math.round(this.options['size'] / 2) - this.options['margin'],
  ...
  this.$radialFirstHalf = $("<div class='second-inner'>").appendTo(this.$radialFirstHalfMask).css({
    "box-sizing": "border-box",
    "-moz-box-sizing": "border-box",
    "-webkit-box-sizing": "border-box",
    "position": "absolute",
  ...
  this.$radialSecondHalf = $("<div class='third-inner'>").appendTo(this.$radialSecondHalfMask).css({
    "box-sizing": "border-box",
    "-moz-box-sizing": "border-box",
    "-webkit-box-sizing": "border-box",
    "position": "absolute",
  ...
  if (this.options['text-color']) {
    this.$radialLabel = $("<div class='values'>").appendTo($obj).css({
      "position": "absolute",
